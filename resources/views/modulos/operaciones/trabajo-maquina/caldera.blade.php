@extends('layouts.web')
@section('title', ' Trabajo caldera | Inducolma')
    ...
    <div class="d-flex flex-wrap row  m-auto align-items-center container-fluid ">
        <div
            ...
            <div class="text-primary">
                <h1 class="display-6">Trabajo en Caldera</h1>
                <hr>
            </div>
            ...
            <!-- Tabla -->
            <div>
                <table id="listaOrdenesCaldera" class="table table-bordered table-striped dt-responsive"
                            ...
                            <td>
                                <div class="d-flex align-items-center ">
                                    <a href="{{ route('trabajo-ensamble',$ensamble->pedido_id) }}"
                                        ...
                                        title="Procesar caldera pedido {{ $ensamble->pedido->id }}">
