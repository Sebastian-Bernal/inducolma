       ...
       <div class="container col-xl-12 col-lg-12 col-md-12 col-sm-12 bg-light shadow rounded-3 min-vh-100 mb-2 mt-2 overflow-scroll"> 
            <div class="d-flex flex-wrap align-items-center ">    
                <div class="self-start col-md-6 col-sm-12 col-12 " >
                    <button class="btn btn-warning text-light mt-2 mb-2 w-100 rounded-pill" type="button" data-bs-toggle="collapse" data-bs-target="#estadoMaquina" aria-expanded="false" aria-controls="estadoMaquina">
                ...
                <div class="self-end col-md-6 col-sm-12 col-12">
                    <button class="btn btn-primary text-light mt-2 mb-2 w-100 rounded-pill" type="button" data-bs-toggle="collapse" data-bs-target="#eventoMaquina" aria-expanded="false" aria-controls="eventoMaquina">
