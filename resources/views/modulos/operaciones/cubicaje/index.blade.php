...
<div class="div container h-content ">
    <div class="row">
        <div class="col-12 col-sm-10 col-lg-6 mx-auto">
            ...
            <button type="button" class="btn btn-outline-primary mb-3" id="registrar" data-bs-toggle="modal"
                data-bs-target="#creaUsuario">
                    Cubicar madera en bloque
            </button>
            <button type="button" class="btn btn-outline-primary mb-3" id="registrar" data-bs-toggle="modal"
                data-bs-target="#cubicarTroza">
                    Cubicar madera en troza
            </button>
            @if ($errors->any())
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content ">
                            ...
                            <div class="modal-body ">
                                <div class=" ">
                                    <input type="entrada" name="entrada" id="entrada"
                                        class="form-control @error('entrada') is-invalid @enderror" required
                                        autocomplete="entrada" autofocus>
                                    @error('entrada')
            ...
            <!-- Modal Busca entrada de la adera en troza-->
            <form id="formRegistro" action="{{ route('cubicaje-troza') }}" method="GET">

                <div class="modal fade" id="cubicarTroza" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content ">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Buscar entrada de madera troza</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body ">
