                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="existencias" 
                                                    ...
                                                    name="existencias" value="{{ old('existencias',$item->existencias) }}" 
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="tipo_madera" 
                                                    ...
                                                    name="tipo_madera" value="{{ old('tipo_madera', $item->tipo_madera) }}" 
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="carretos" 
                                                    ...
                                                    name="carretos" value="{{ old('carretos',$item->carretos) }}" 
