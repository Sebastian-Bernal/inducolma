                ...
                <div class="container-sm col-sm-auto card  bg-light shadow m-3 rounded-3">
                    ...
                    <div class=" card-body">
                        ...
                        <div class="input-group mb-3 mt-3">
                          ...
                          <div>
                            <button class=" bg-secondary text-center text-white container p-2 rounded" onClick="agregaRutaInicial()">Agregar a rutas</button>
                          </div>
                    </div>
                ...
                <div class="container-sm col-sm-auto card  bg-light shadow m-3 rounded-3">
                    ...
                    <div class=" card-body">
                        ...
                        <div class="input-group mb-3 mt-3">
                          ...
                          <div>
                            <button class=" bg-secondary text-center text-white container p-2 rounded" onClick="agregaRutaIntermedia()">Agregar a rutas</button>
                          </div>
                    </div>
                ...
                <div class="container-sm col-sm-auto card  bg-light shadow m-3 rounded-3">
                    ...
                    <div class=" card-body">
                        ...
                        <div class="input-group mb-3 mt-3">
                          ...
                          <div>
                            <button class=" bg-secondary text-center text-white container p-2 rounded" onClick="agregaRutaFinal()">Agregar a rutas</button>
                          </div>
                    </div>
                ...
                <div class="container-sm col-sm-auto card  bg-light shadow m-3 rounded-3">
                    ...
                    <div class=" card-body">
                        ...
                        <div class="input-group mb-3 mt-3">
                          ...
                          <div>
                            <button class=" bg-secondary text-center text-white container p-2 rounded" onClick="agregaRutaAcabados()">Agregar a rutas</button>
                          </div>
                    </div>
