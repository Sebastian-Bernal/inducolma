        ...
        <div class="row">            
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    @foreach ($pedido->items_pedido as $items)
                        ...
                        <tr id="{{ $items->item_id }}">
                            ...
                            <td>
                                <div class="row row-cols-lg-auto g-3 align-items-center">
                                    <form action="{{ route('contruccion') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="cantidad" value="{{  $items->total }}">
                                        <input type="hidden" name="id_item"value="{{ $items->item_id }}">
                                        <input type="hidden" name="id_pedido" value="{{ $pedido->id }}">
                                        <button class="btn btn-primary" title="Procesar item">
