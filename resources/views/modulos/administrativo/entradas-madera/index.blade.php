...
<div class="div container h-content ">
    <div class="row">
        <div class="col-12 col-sm-10 col-lg-6 mx-auto">
            ...
            <button type="button" class="btn btn-primary mb-3" id="registrar" data-bs-toggle="modal"
                data-bs-target="#creaUsuario">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body m-3">
                                ...
                                <div class="row g-3" id="formEntradaMaderas">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row mb-3">
                                            <label for="mes"
                                                class="col-md-3 col-form-label text-md-end px-0 pt-7 pb-7 ">{{ __('Mes')
                                                }}</label>
                                            <div class="col-md-8">
                                                <select name="mes" id="mes"
                                                    class="form-control @error('mes') is-invalid @enderror" required
                                                    autocomplete="mes" autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="row mb-3">
                                            <label for="ano"
                                                class="col-md-3 col-form-label text-md-end px-0 pt-7 pb-7">{{ __('Año')
                                                }}</label>
                                            <div class="col-md-8">
                                                <select name="ano" id="ano"
                                                    class="form-control @error('ano') is-invalid @enderror" required
                                                    autocomplete="ano" autofocus>
                                                    {{ $ano = date('Y') }}
                                                    @while ($ano >= 1990)
                                    ...
                                    <div class="col-md-4">
                                        <div class="row mb-3">
                                            <label for="hora"
                                                class="col-md-3 col-form-label text-md-end px-0 pt-7 pb-7">{{ __('Hora')
                                                }}</label>
                                            <div class="col-md-8">
                                                <input type="time" name="hora" id="hora"
                                                    class="form-control @error('hora') is-invalid @enderror" required
                                                    autocomplete="hora" autofocus value="{{ date('H:i:s') }}">
                                                @error('hora')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="row mb-3">
                                            <label for="fecha"
                                                class="col-md-3 col-form-label text-md-end px-0 pt-7 pb-7">{{
                                                __('Fecha') }}</label>
                                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row mb-3">
                                            <label for="actoAdministrativo"
                                                class="col-md-3 col-form-label text-md-center px-0 pt-0 pb-7">{{
                                                __('Acto administrativo') }}</label>
                                            <div class="col-md-8">
                                                <input type="text" name="actoAdministrativo" id="actoAdministrativo"
                                                    class="form-control @error('actoAdministrativo') is-invalid @enderror text-uppercase"
                                                    required autocomplete="actoAdministrativo">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row mb-3">
                                            <label for="salvoconducto"
                                                class="col-md-3 col-form-label text-md-center px-0 pt-0 pb-7">{{
                                                __('Salvoconducto remision') }}</label>
                                            <div class="col-md-8">
                                                <input type="number" name="salvoconducto" step="0.1" id="salvoconducto"
                                                    class="form-control @error('salvoconducto') is-invalid @enderror text-uppercase"
                                                    required autocomplete="salvoconducto" autofocus>
                                                @error('salvoconducto')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="row mb-3">
                                            <label for="titularSalvoconducto"
                                                class="col-md-3 col-form-label text-md-center px-0 pt-0 pb-7">{{
                                                __('Titular salvoconducto') }}</label>
                                            <div class="col-md-8">
                                                <input type="text" name="titularSalvoconducto" id="titularSalvoconducto"
                                                    class="form-control @error('titularSalvoconducto') is-invalid @enderror text-uppercase"
                                                    required autocomplete="titularSalvoconducto" autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="row mb-3">
                                            <label for="entidadVigilante"
                                                class="col-md-3 col-form-label text-md-center px-0 pt-0 pb-7">{{
                                                __('Entidad vigilante') }}</label>
                                            <div class="col-md-8">
                                                <input type="text" name="entidadVigilante" id="entidadVigilante"
                                                    class="form-control @error('entidadVigilante') is-invalid @enderror text-uppercase"
                                                    required autocomplete="entidadVigilante" autofocus>
                                ...
                                <div class="row g-3" id="formMaderas">
                                    <div class="col-md-4">
                                        <div class="row mb-3">
                                            <label for="madera"
                                                class="col-md-2 col-form-label text-md-end px-0 pt-7 pb-7">{{
                                                __('Madera') }}</label>
                                            <div class="col-md-8">
                                                <select name="madera" id="madera"
                                                    class="form-control @error('madera') is-invalid @enderror"
                                                    autocomplete="madera" required autofocus>
                                                    <option value="" selected>Seleccione...</option>
                                                    @foreach ($maderas as $madera)
                                                    <option value="{{ $madera->id }}">{{ $madera->nombre_cientifico }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                                @error('madera')
                                    ...
                                    <div class="col-md-3">
                                        <div class="row mb-3">
                                            <label for="condicionMadera"
                                                class="col-md-3 col-form-label text-md-center px-0 pt-0 pb-0">{{
                                                __('Condicion madera') }}</label>
                                            <div class="col-md-8">
                                                <select name="condicionMadera" id="condicionMadera"
                                                    class="form-control @error('condicionMadera') is-invalid @enderror"
                                                    required autocomplete="condicionMadera" autofocus>
                                                    <option value="" selected>Seleccione..</option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="row mb-3">
                                            <label for="m3entrada"
                                                class="col-md-3 col-form-label text-md-center px-0 pt-0 pb-7">{{
                                                __('Metros cubicos de entrada') }}</label>
                                            <div class="col-md-8">
                                                <input type="number" name="m3entrada" step="0.1" min="1" max="1000"
                                                    id="m3entrada"
                                                    class="form-control @error('m3entrada') is-invalid @enderror"
                                                    required autocomplete="m3entrada" autofocus>
                                                @error('m3entrada')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-2">
                                        <div>
                                            <button type="button" class="btn btn-primary"
                                                onclick="agregarMadera()">Agregar madera</button>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                                    onclick="borrarMaderas()">Cancelar</button>
                                <button type="button" class="btn btn-primary" onclick="validarCampos()">Guardar
                                    entrada</button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="justify-content-left">
                <button class="btn btn-warning" id="editarUltimo" onclick="editarUltimo()">Editar ultima
                    entrada</button>
            </div>
