    ...
    <div class="row">
        <div class="col-12 col-sm-10 col-lg-6 mx-auto">
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <label for="productos" class="col-md-4 col-form-label text-md-end">{{
                                            __('Producto') }}</label>
                                        <div class="col-md-6">
                                            <select id="productos" type="text"
                                                class="form-control @error('productos') is-invalid @enderror text-uppercase"
                                                name="productos" value="{{ old('productos') }}" required
                                                autocomplete="productos" autofocus>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                                    onclick="volverAPedido()">Cerrar</button>
                                <button type="button" class="btn btn-primary" onclick="asignarDiseno()">Asignar
                                    diseño</button>
                            </div>
                        </div>
                    </div>
            ...
            <form action="{{ route('pedidos.store') }}" method="POST">
                @csrf
                <div class="modal fade" id="creapedido" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <div class="d-flex justify-content-end">
                                    <button type="button" class="btn btn-outline-primary btn-sm mb-3 "
                                        data-bs-toggle="modal" data-bs-target="#creadiseno" id="btnAsignar">
                                        Asignar diseño a cliente
                                    </button>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <label for="cliente" class="col-md-4 col-form-label text-md-end">{{
                                            __('Cliente') }}</label>
                                        <div class="col-md-6">
                                            <select id="cliente" type="number"
                                    ...
                                    <div class="row mb-3">
                                        <label for="items" class="col-md-4 col-form-label text-md-end">{{ __('Producto')
                                            }}</label>
                                        <div class="col-md-6">
                                            <div class="d-flex justifu-content-between">
                                                <select id="items"
                                                    class="form-control @error('items') is-invalid @enderror text-uppercase"
                                                    name="items" value="{{ old('items') }}" required
                                                    autocomplete="items" autofocus onkeyup="mayusculas()">
                                                </select>
                                    ...
                                    <div class="row mb-3">
                                        <label for="fecha_entrega" class="col-md-4 col-form-label text-md-end">{{
                                        ...
                                        <div class="col-md-6">
                                            <input id="fecha_entrega" type="date"
                                                ...
                                                min="{{ date('Y-m-j', strtotime('10 weekdays')) }}" name="fecha_entrega"
                                                value="{{ old('fecha_entrega') }}" required autocomplete="fecha_entrega"
                                                autofocus onkeyup="mayusculas()">
